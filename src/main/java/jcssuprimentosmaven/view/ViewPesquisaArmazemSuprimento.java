...
import jcssuprimentosmaven.ouvinte.OuvinteViewDadosArmazemSuprimento;
 ...
 * @author Gustavo
 */
public class ViewPesquisaArmazemSuprimento extends javax.swing.JInternalFrame {

    private ViewDadosArmazemSuprimento viewDadosArmazem;
     ...
     */
    public ViewPesquisaArmazemSuprimento() {
        initComponents();
    }
    
    public ViewPesquisaArmazemSuprimento(Jogador usuario) {
        initComponents();
    ...
    private void abrirViewDadosArmazem(ArmazemSuprimento armazem, String acao) {
       // if (viewDadosJogador == null) {
            viewDadosArmazem = new ViewDadosArmazemSuprimento();
            OuvinteViewDadosArmazemSuprimento ouvinte = new OuvinteViewDadosArmazemSuprimento(viewDadosArmazem);
    ...
    public void listar(List armazens) {
        try {
            ...
            while (resultado.hasNext()) {
                ArmazemSuprimento armazemTemp = (ArmazemSuprimento) resultado.next();
                ...
                String fabrica = armazemTemp.getFabrica().getNomeFantasia();
                              
                Object[] linha = {nomeFantasia, taxaDiaria, taxaSeguro, fabrica};
                model.addRow(linha);
            }
    ...
    public ArmazemSuprimento getArmazem() {
        ArmazemSuprimento armazemTemp = null;
        try {
            ...
            armazemTemp = (ArmazemSuprimento) this.armazens.get(linhaSelecionada);
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa - Armazém Suprimento");
        ...
        tArmazens.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Taxa Diária", "Taxa de Seguro", "Fábrica"
            }
        ) {
    ...
    private void bNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNovoActionPerformed
        ...
        ArmazemSuprimento armazem = new ArmazemSuprimento();
