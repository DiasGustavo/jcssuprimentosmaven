 ...
 * @author Gustavo
 */
public class ViewDadosFornecedor extends javax.swing.JInternalFrame {
    ...
    public Fornecedor preencherFornecedor() {
        
        fornecedor.setFantasia(this.jtxNome.getText()); 
        fornecedor.setEmpresa((Empresa)this.cbEmpresa.getSelectedItem());

        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        Validator validator = factory.getValidator();
        Set<ConstraintViolation<Fornecedor>> constraintViolation = validator.validate(fornecedor);

        if (!constraintViolation.isEmpty()) {
            String mensagem = "";
            for (ConstraintViolation<Fornecedor> erro : constraintViolation) {
    ...
    public void exibirFornecedor(Fornecedor fornecedor) {
        this.limparCampos();
        //if (juiz != null) {
            this.jtxNome.setText(fornecedor.getFantasia());            
        //} 
    }
    ...
    private void initComponents() {
        ...
        pDadosJuiz.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Fornecedor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
