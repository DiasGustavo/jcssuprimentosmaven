...
import jcssuprimentosmaven.ouvinte.OuvinteViewDadosArmazemDistribuicao;
 ...
 * @author Gustavo
 */
public class ViewPesquisaArmazemDistribuicao extends javax.swing.JInternalFrame {

    private ViewDadosArmazemDistribuicao viewDadosArmazem;
     ...
     */
    public ViewPesquisaArmazemDistribuicao() {
        initComponents();
    }
    
    public ViewPesquisaArmazemDistribuicao(Jogador usuario) {
        initComponents();
    ...
    private void abrirViewDadosArmazem(ArmazemDistribuicao armazem, String acao) {
       // if (viewDadosJogador == null) {
            viewDadosArmazem = new ViewDadosArmazemDistribuicao();
            OuvinteViewDadosArmazemDistribuicao ouvinte = new OuvinteViewDadosArmazemDistribuicao(viewDadosArmazem);
    ...
    public void listar(List armazens) {
        try {
            ...
            while (resultado.hasNext()) {
                ArmazemDistribuicao armazemTemp = (ArmazemDistribuicao) resultado.next();
                ...
                Object[] linha = {nomeFantasia, taxaDiaria, taxaSeguro};
                model.addRow(linha);
            }
    ...
    public ArmazemDistribuicao getArmazem() {
        ArmazemDistribuicao armazemTemp = null;
        try {
            ...
            armazemTemp = (ArmazemDistribuicao) this.armazens.get(linhaSelecionada);
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa - Armazém Distribuição");
        ...
        tArmazens.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Taxa Diária", "Taxa de Seguro"
            }
        ) {
    ...
    private void bNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNovoActionPerformed
        ...
        ArmazemDistribuicao armazem = new ArmazemDistribuicao();
