 ...
 * @author Gustavo
 */
public class ViewPesquisaArmazemFabrica extends javax.swing.JInternalFrame {
    ...
    public void listar(List armazens) {
        try {
            ...
            while (resultado.hasNext()) {
                ArmazemFabrica armazemTemp = (ArmazemFabrica) resultado.next();
                String Quantidade = armazemTemp.getQuantidade().toEngineeringString();
                String fabrica = armazemTemp.getFabrica().getNomeFantasia();
                String materia = armazemTemp.getMateriaPrima().getDescricao();
                              
                Object[] linha = { Quantidade, materia, fabrica};
                model.addRow(linha);
            }
    ...
    public ArmazemFabrica getArmazem() {
        ArmazemFabrica armazemTemp = null;
        try {
            ...
            armazemTemp = (ArmazemFabrica) this.armazens.get(linhaSelecionada);
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa - Armazém Fábrica");
        ...
        tArmazens.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Quantidade", "Matéria-Prima", "Fábrica"
            }
        ) {
    ...
    private void bNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNovoActionPerformed
        ...
        ArmazemFabrica armazem = new ArmazemFabrica();
        armazem.setQuantidade(BigDecimal.ZERO);
